...
# CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 --master_addr 127.0.0.1 --master_port 30000 main.py \
#     --config_path "configs/Skin7/r50_CE.yaml"

# Baseline
CUDA_VISIBLE_DEVICES=$1 python3 train.py --config_path $2
