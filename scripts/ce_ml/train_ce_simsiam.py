...
class Trainer(BaseTrainer):
    ...
    def train_epoch(self, cur_epoch, trainloader, model, criterion, optimizer,
        ...
        for i, (batch_imgs, batch_targets) in enumerate(trainloader):
            ...
            p1, p2, z1, z2, fc1, fc2 = model(batch_imgs1,
                                             batch_imgs2,
                                             out_type='simsiam+fc')
            loss1 = criterion(fc1, batch_targets) + \
                criterion(fc2, batch_targets)
            loss2 = criterion2(p1, p2, z1, z2)
            ...
            batch_preds = torch.argmax(fc1, dim=1)
