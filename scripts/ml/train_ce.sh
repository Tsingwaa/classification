...
CUDA_VISIBLE_DEVICES="$1" python3 train_ce.py --config_path configs/PathMNIST/r50pre_simclr.yaml
# CUDA_VISIBLE_DEVICES="$1" python3 train_ce.py --config_path configs/PathMNIST/r50pre_supcon.yaml
