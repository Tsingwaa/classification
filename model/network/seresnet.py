...
@Networks.register_module("seresnet")
class SERESNET(nn.Module):
    def __init__(self, num_classes=100, pretrained=False, config=None,
        ...
        if backbone_name not in ['se_resnet50', 'se_resnext101_32x4d']:
        ...
        logging.info('seresnet : using {} as feature extractor, \
    ...
    def load_state_dict(self, state_dict, strict=True):
        ...
        super(SERESNET, self).load_state_dict(model_dict)
