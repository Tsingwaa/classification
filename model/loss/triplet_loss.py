...
def hard_example_mining(dist_mat, labels, return_inds=False):
    ...
    Args:
      dist_mat: pytorch Variable, pair wise distance between samples\
              , shape [N, N]
...
@Losses.register_module("TripletLoss")
class TripletLoss(object):
    """Modified from Tong Xiao's open-reid (https://github.com/Cysu/open-reid).
    Related Triplet Loss theory can be found in paper 'In Defense of the
