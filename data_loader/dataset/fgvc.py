...
# [('Boeing', 1466), ('Airbus', 867), ('McDonnell Douglas', 467), ('Embraer', 467), ('de Havilland', 334), 
# ('British Aerospace', 267), ('Douglas Aircraft Company', 267), ('Canadair', 267), ('Cessna', 266), ('Fokker', 200), 
# ('Beechcraft', 134), ('Lockheed Corporation', 134), ('Saab', 134), ('ATR', 133), ('Dassault Aviation', 133), 
# ('Gulfstream Aerospace', 133), ('Tupolev', 133), ('Antonov', 67), ('Dornier', 67), ('Lockheed Martin', 67), 
# ('Bombardier Aerospace', 67), ('Piper', 67), ('Panavia', 67), ('Yakovlev', 67), ('Robin', 66), ('Eurofighter', 66), 
# ('Ilyushin', 66), ('Fairchild', 66), ('Cirrus Aircraft', 66), ('Supermarine', 66)]
...
class FGVC(torch.utils.data.Dataset):
    ...
    name2label = {'Boeing': 0, 'Airbus': 1, 'McDonnell Douglas': 2, 'Embraer': 3, 'de Havilland': 4, 
            'British Aerospace': 5, 'Douglas Aircraft Company': 6, 'Canadair': 7, 'Cessna': 8, 
            'Fokker': 9, 'Beechcraft': 10, 'Lockheed Corporation': 11, 'Saab': 12, 'ATR': 13, 
            'Dassault Aviation': 14, 'Gulfstream Aerospace': 15, 'Tupolev': 16, 'Antonov': 17, 
            'Dornier': 18, 'Lockheed Martin': 19, 'Bombardier Aerospace': 20, 'Piper': 21, 'Panavia': 22,
             'Yakovlev': 23, 'Robin': 24, 'Eurofighter': 25, 'Ilyushin': 26, 'Fairchild': 27, 
             'Cirrus Aircraft': 28, 'Supermarine': 29}

    label2name = {0: 'Boeing', 1: 'Airbus', 2: 'McDonnell Douglas', 3: 'Embraer', 4: 'de Havilland', 
            5: 'British Aerospace', 6: 'Douglas Aircraft Company', 7: 'Canadair', 8: 'Cessna', 
            9: 'Fokker', 10: 'Beechcraft', 11: 'Lockheed Corporation', 12: 'Saab', 13: 'ATR', 
            14: 'Dassault Aviation', 15: 'Gulfstream Aerospace', 16: 'Tupolev', 17: 'Antonov', 
            18: 'Dornier', 19: 'Lockheed Martin', 20: 'Bombardier Aerospace', 21: 'Piper', 
            22: 'Panavia', 23: 'Yakovlev', 24: 'Robin', 25: 'Eurofighter', 26: 'Ilyushin', 
            27: 'Fairchild', 28: 'Cirrus Aircraft', 29: 'Supermarine'}
    ...
    def __init__(self,
        ...
        self.targets = []
        if self.phase == 'train':
            with open(join(root, 'data/images_manufacturer_trainval.txt'), 'r') as f:
                for line in f.readlines():
                    image_id, target = line[:7], line[8:-1]
                    self.img_paths.append(join(root, f'data/images/{image_id}.jpg'))
                    self.targets.append(self.name2label[target])
        else:
            with open(join(root, 'data/images_manufacturer_test.txt'), 'r') as f:
                for line in f.readlines():
                    image_id, target = line[:7], line[8:-1]
                    self.img_paths.append(join(root, f'data/images/{image_id}.jpg'))
                    self.targets.append(self.name2label[target])
